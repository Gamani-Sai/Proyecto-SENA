                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="disabledSelect">Nombre Profesor</label>
                            <input type="text" id="disabledTextInput" class="form-control2" placeholder="pipeMRamirez">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="disabledTextInput" class="form-control2" placeholder="Manuel Felipe Ramirez">
                        </div>
                        <div class="form-group">
                            <label for="disabledSelect">Hora reserva</label>
                            <input type="time" id="disabledTextInput" class="form-control2" placeholder="4839483948">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="disabledSelect">Serial Del Elemento</label>
                            <input type="text" id="disabledTextInput" class="form-control2" placeholder="pipeMRamirez">
