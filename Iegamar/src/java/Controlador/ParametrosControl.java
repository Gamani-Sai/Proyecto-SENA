...
entidadProfesores p=new entidadProfesores();
    public String Datos(String Radio) throws SQLException {
        ...
        if (Radio.equals("Profesores")) {
            ...
            Recorrer += "<select  id=\"ConProEsT\" name=\"selector\"  >";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ParametrosControl.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
