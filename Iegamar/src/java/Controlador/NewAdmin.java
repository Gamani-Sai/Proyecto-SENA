...
public class NewAdmin extends HttpServlet {
     ...
     */
    entidadCuenta datosUsuario = new entidadCuenta();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String Cuenta = request.getParameter("nombreUsuario");
            String Contra = request.getParameter("contrasena");
            datosUsuario.setLogin(Cuenta);
            datosUsuario.setPassword(Contra);
            
            if (Usu.modificarCuentaAdmin(datosUsuario)) {
